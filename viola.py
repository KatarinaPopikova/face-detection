...
if __name__ == '__main__':
    ...
    csv_path = 'data/saveData_viola_best'
    ...
    with open(csv_path + '.csv', 'w', encoding='UTF8', newline='') as f:
        ...
        for file in files:
            ...
            load_save_video('data/output/viola_best/' + file[:-4] + '/original', colorImg_original, boundingBox,
                            landmarks2D, writer)
            load_save_video('data/output/viola_best/' + file[:-4] + '/medium', colorImg_medium, boundingBox,
                            landmarks2D, writer)
            load_save_video('data/output/viola_best/' + file[:-4] + '/severe', colorImg_serve, boundingBox, landmarks2D,
                            writer)
